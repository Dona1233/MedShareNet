...
const AddResource = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.title || !form.description || !form.category || !form.condition || !form.quantity || !form.location) {
  ...
  return (
    <Layout>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">Donate a Resource</h1>
        <p className="text-gray-500">Fill in the details of the medical resource you want to donate</p>
      </div>
        ...
        <Card>
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex gap-3 mt-2">
              ...
              <Button variant="secondary" onClick={() => navigate('/donor')} type="button">
                Cancel
              </Button>
            </div>
          </form>
